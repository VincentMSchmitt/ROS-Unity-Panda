...
public class DirectKinematics {
    ...
    public static void LogMatrix(string matrixName, Matrix4x4 matrix) {
        Debug.Log(matrixName + ":");
        Debug.Log(matrix.ToString("F4"));
    }
}